...
echo round($conv->FtoC($_POST["Fahrenheit"]), 2);
echo '</td>';
echo '</tr>';
echo '<tr>';
echo '<td width="20%" align="left">Kiligrams:</td>';
echo '<td width="20%" align="left">';
echo round($conv->LBtoKG($_POST["Pounds"]), 2);
echo '</td>';
echo '</tr>';
echo '<tr>';
echo '<td width="20%" align="left">Kilometers:</td>';
echo '<td width="20%" align="left">';
echo round($conv->MItoKM($_POST["Miles"]), 2);
echo '</td>';
echo '</tr>';
echo '<tr border="0">';
echo '<td align="left">';
echo '<input type="submit" value="Back" name="calc">';
echo '</td>';
echo '</tr>';
echo '</table>';
echo '</form>';
